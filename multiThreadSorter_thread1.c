...
//testing stuffs
 ...
 printf("THEEEE OUTPUT DIR IS : %s\n", outputDir);
        ...
        //return 0;
        /*test---------------------*/
        threadID = (pthread_t *)malloc(sizeof(pthread_t)*400);  //tiff added
        ...
        //this is temp comment line
        //trying to commit to git but there's an issue whoops   
        int i;
